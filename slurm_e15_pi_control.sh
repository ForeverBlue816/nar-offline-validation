#!/bin/bash
#SBATCH --job-name=nar-e15-pi
#SBATCH --gpus=rtx5090:1
#SBATCH --time=12:00:00
#SBATCH --output=runs/e15-pi-%j.out
#SBATCH --error=runs/e15-pi-%j.err
#SBATCH --requeue
set -euo pipefail
umask 0007
...
exec "$python_bin" "$code_dir/nar/e15_pi_control.py" --workdir "$NAR_WORKDIR"
