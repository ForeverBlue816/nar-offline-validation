#!/usr/bin/env python3
"""Generate Figure 4/5 source-derived captions and LaTeX inclusion; CPU only."""
import json
...
def main():
    ...
    captions={'fig4_revised':fig4,'fig5':efficiency,'appendix':appendix}
    (HERE/'fig5_caption.txt').write_text('Figure 5. '+efficiency+'\n')
    ...
    def tex(s):
        ...
        return s
    (HERE/'captions.tex').write_text('% Generated from frozen plotting data; deployment efficiency is Figure 5.\n'+
