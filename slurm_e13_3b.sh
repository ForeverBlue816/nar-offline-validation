#!/bin/bash
#SBATCH --job-name=nar-e13-3b
#SBATCH --gpus=rtx5090:1
#SBATCH --time=2-00:00:00
#SBATCH --output=runs/e13-3b-%j.out
#SBATCH --error=runs/e13-3b-%j.err
#SBATCH --requeue
set -euo pipefail
umask 0007
...
for method in bf16 hadamard nar; do
    "$python_bin" "$code_dir/nar/e13_zero_shot.py" --workdir "$NAR_WORKDIR" run --model llama32_3b --method "$method"
done
exec "$python_bin" "$code_dir/nar/e13_zero_shot.py" --workdir "$NAR_WORKDIR" finalize --model llama32_3b
