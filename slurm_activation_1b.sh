#!/bin/bash
#SBATCH --job-name=nar-e5-1b
#SBATCH --gpus=rtx5090:1
#SBATCH --time=1-12:00:00
#SBATCH --output=runs/e5-1b-%j.out
#SBATCH --error=runs/e5-1b-%j.err
#SBATCH --requeue
set -euo pipefail
umask 0007
...
"$python_bin" "$code_dir/nar/activation_experiments.py" --workdir "$work_dir" calibrate --model llama32_1b
exec "$python_bin" "$code_dir/nar/activation_experiments.py" --workdir "$work_dir" e5 --model llama32_1b
