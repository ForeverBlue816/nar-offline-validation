...
Core timing: **11/72** independent processes complete. Full timing completion does not override any numerical failure below.
...
Real base-checkpoint FP16 implementation checks: 3b: PENDING; 8b: PENDING. This is separate from compensated INT4 checkpoint support and from model quality. Prefill hidden/logits and multi-step decode are checked; exact cache comparisons cover steps1,2,9,64,65,128.
...
- 3b prefill1: Hadamard/FP16 speedup 1.26; PrismQuant/FP16 1.25. fewer than three comparable sessions; no stable advantage established.
- 3b prefill16: Hadamard/FP16 speedup 1.29; PrismQuant/FP16 1.27. fewer than three comparable sessions; no stable advantage established.
- 3b decode: Hadamard/FP16 speedup 0.48; PrismQuant/FP16 0.51. fewer than three comparable sessions; no stable advantage established.
