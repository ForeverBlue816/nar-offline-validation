...
| 3b | FP16 | eager_sequence / prefill16 | 2 | 14004.63 | 50.56 | 50 |
| 3b | FP16 | eager_sequence / prefill16 | 3 | 13986.46 | 47.55 | 50 |
| 3b | FP16 | eager_step_sync / decode | 1 | 23.12 | 0.18 | 50 |
| 3b | FP16 | eager_step_sync / decode | 2 | 23.13 | 0.16 | 50 |
| 3b | FP16 | eager_step_sync / decode | 3 | 23.53 | 0.24 | 50 |
...
| 3b | QuaRot Hadamard | eager_sequence / prefill16 | 2 | 17901.65 | 15.34 | 50 |
| 3b | QuaRot Hadamard | eager_sequence / prefill16 | 3 | 17884.68 | 14.34 | 50 |
| 3b | QuaRot Hadamard | eager_step_sync / decode | 1 | 43.10 | 0.45 | 50 |
| 3b | QuaRot Hadamard | eager_step_sync / decode | 2 | 45.17 | 0.67 | 50 |
| 3b | QuaRot Hadamard | eager_step_sync / decode | 3 | 46.05 | 0.73 | 50 |
...
| 3b | PrismQuant k=8 | eager_sequence / prefill16 | 2 | 17635.31 | 22.86 | 50 |
| 3b | PrismQuant k=8 | eager_sequence / prefill16 | 3 | 17614.34 | 24.45 | 50 |
| 3b | PrismQuant k=8 | eager_step_sync / decode | 1 | 44.01 | 0.37 | 50 |
| 3b | PrismQuant k=8 | eager_step_sync / decode | 2 | 46.15 | 0.86 | 50 |
| 3b | PrismQuant k=8 | eager_step_sync / decode | 3 | 45.02 | 0.73 | 50 |
...
| 8b | FP16 | eager_sequence / prefill16 | 1 | 6419.61 | 25.40 | 50 |
| 8b | FP16 | eager_sequence / prefill16 | 2 | 6422.42 | 18.66 | 50 |
| 8b | FP16 | eager_sequence / prefill16 | 3 | 6404.61 | 43.26 | 50 |
| 8b | FP16 | eager_step_sync / decode | 1 | 31.07 | 0.05 | 50 |
| 8b | FP16 | eager_step_sync / decode | 2 | 31.32 | 0.11 | 50 |
| 8b | FP16 | eager_step_sync / decode | 3 | 31.13 | 0.09 | 50 |
...
| 8b | QuaRot Hadamard | eager_sequence / prefill16 | 1 | 9561.35 | 10.38 | 50 |
| 8b | QuaRot Hadamard | eager_sequence / prefill16 | 2 | 9538.30 | 10.73 | 50 |
| 8b | QuaRot Hadamard | eager_sequence / prefill16 | 3 | 9566.44 | 13.94 | 50 |
| 8b | QuaRot Hadamard | eager_step_sync / decode | 1 | 53.29 | 0.33 | 50 |
| 8b | QuaRot Hadamard | eager_step_sync / decode | 2 | 55.36 | 1.16 | 50 |
| 8b | QuaRot Hadamard | eager_step_sync / decode | 3 | 56.67 | 1.17 | 50 |
...
| 8b | PrismQuant k=8 | eager_sequence / prefill16 | 1 | 9656.45 | 17.92 | 50 |
| 8b | PrismQuant k=8 | eager_sequence / prefill16 | 2 | 9670.85 | 33.68 | 50 |
| 8b | PrismQuant k=8 | eager_sequence / prefill16 | 3 | 9652.57 | 21.51 | 50 |
| 8b | PrismQuant k=8 | eager_step_sync / decode | 1 | 54.00 | 1.01 | 50 |
| 8b | PrismQuant k=8 | eager_step_sync / decode | 2 | 51.38 | 0.61 | 50 |
| 8b | PrismQuant k=8 | eager_step_sync / decode | 3 | 50.34 | 0.29 | 50 |
