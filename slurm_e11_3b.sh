#!/bin/bash
#SBATCH --job-name=nar-e11-3b
#SBATCH --gpus=rtx5090:1
#SBATCH --time=1-12:00:00
#SBATCH --output=runs/e11-3b-%j.out
#SBATCH --error=runs/e11-3b-%j.err
#SBATCH --requeue
set -euo pipefail
umask 0007
...
"$python_bin" "$code_dir/nar/e11_fair_baselines.py" --workdir "$NAR_WORKDIR" calibrate --model llama32_3b --batch-size 2
exec "$python_bin" "$code_dir/nar/e11_fair_baselines.py" --workdir "$NAR_WORKDIR" evaluate --model llama32_3b
