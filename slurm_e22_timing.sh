#!/bin/bash
#SBATCH --job-name=nar-e22-timing
#SBATCH --gpus=a40:1
#SBATCH --time=00:40:00
#SBATCH --output=runs/e22-timing-%j.out
#SBATCH --error=runs/e22-timing-%j.err
set -euo pipefail
...
"$NAR_WORKDIR/venv/bin/python" "$code_dir/nar/e22_decode_timing.py" --workdir "$NAR_WORKDIR" --model "${NAR_E22_MODEL:-qwen3_0.6b_base}" ${NAR_E22_TIMING_ARGS:-}
