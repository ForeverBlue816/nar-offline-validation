#!/bin/bash
#SBATCH --job-name=nar-e1bcd
#SBATCH --gpus=6000ada:1
#SBATCH --time=1-00:00:00
#SBATCH --output=runs/extensions-%j.out
#SBATCH --error=runs/extensions-%j.err
#SBATCH --requeue
...
exec "$work_dir/venv/bin/python" "$code_dir/nar/extended_experiment.py" --workdir "$work_dir" all
