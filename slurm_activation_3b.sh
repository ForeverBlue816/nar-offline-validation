#!/bin/bash
#SBATCH --job-name=nar-e5-3b
#SBATCH --gpus=rtx5090:1
#SBATCH --time=1-12:00:00
#SBATCH --output=runs/e5-3b-%j.out
#SBATCH --error=runs/e5-3b-%j.err
#SBATCH --requeue
set -euo pipefail
umask 0007
...
exec "$python_bin" "$code_dir/nar/activation_experiments.py" --workdir "$work_dir" e5 --model llama32_3b
